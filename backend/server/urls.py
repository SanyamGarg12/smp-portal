...
urlpatterns = [
    ...
    path('api/deleteMentorById/', views.delete_mentor_by_id,
         name='deleteMentorById'),
    path('api/deleteMenteeById/', views.delete_mentee_by_id,
         name='deleteMenteeById'),
    ...
    path('api/deleteMeetingById/', views.delete_meeting_by_id,
         name='deleteMeetingById'),
    ...
    path('api/createMentorMenteePair/', views.create_mentor_mentee_pairs,
         name='createMentorMenteePair'),

    # forms API
    path('api/submitConsentForm/', views.submit_consent_form,
         name='submitConsentForm'),
    ...
    path('api/menteeFilledFeedback/', views.mentee_filled_feedback,
         name='menteeFilledFeedback'),
    path('api/sendConsentForm/', views.send_consent_form, name='sendConsentForm'),
    path('api/getExcellenceAward/', views.get_excellence_award,
         name='getExcellenceAward'),
    path('api/updateExcellenceAward/', views.update_excellence_award,
         name='updateExcellenceAward'),

    # Mail APIs
    path('api/getMailSubjectAndBody/', views.get_mail_subject_and_body,
         name="getMailSubjectAndBody"),
]
